...
#poor HS
cluster1 <- cbind(runif(150, min = 0, max = 200),
                  runif(150, min = 0, max = 200),
                  runif(150, min = 0, max = 200))
cluster2 <- cbind(runif(150, min = 0, max = 200),
                  runif(150, min = 0, max = 200),
                  runif(150, min = 0, max = 200))

```

Data set with high HS:
...
# high HS
cluster1 <- cbind(rnorm(150, mean = 40, sd = 0.5), 
                   rnorm(150, mean = 30, sd = 0.5), 
                   rnorm(150, mean = 50, sd = 0.5))
...
Plot the data set and calculate the Hopkins Statistics for all pairs:
